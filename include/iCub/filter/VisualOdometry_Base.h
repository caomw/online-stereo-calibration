...
void ImageToWorld(cv::Point2d LeftFeatureCoordinates, cv::Point2d RightFeatureCoordinates, cv::Mat Encoders, cv::Mat LeftCamCalibMat,
									   cv::Mat RightCamCalibMat, cv::Point3d &WorldPoint);
