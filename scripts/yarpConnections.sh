...
sleep 2
yarp connect /icub/head/state:o /moutinho_stereo_calib/head_encoders/state &
yarp connect /icub/cam/left /moutinho_stereo_calib/image/left &
yarp connect /icub/cam/right /moutinho_stereo_calib/image/right &
